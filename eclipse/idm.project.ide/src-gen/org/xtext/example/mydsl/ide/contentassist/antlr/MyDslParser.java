...
public class MyDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRemoveColAccess().getAlternatives(), "rule__RemoveCol__Alternatives");
			builder.put(grammarAccess.getInsertAccess().getValueAlternatives_5_0(), "rule__Insert__ValueAlternatives_5_0");
			builder.put(grammarAccess.getPrintAccess().getValueAlternatives_1_0(), "rule__Print__ValueAlternatives_1_0");
			builder.put(grammarAccess.getExpressionAccess().getAlternatives(), "rule__Expression__Alternatives");
			builder.put(grammarAccess.getPrimaryExpressionAccess().getAlternatives(), "rule__PrimaryExpression__Alternatives");
			builder.put(grammarAccess.getColsumAccess().getAlternatives(), "rule__Colsum__Alternatives");
			builder.put(grammarAccess.getColprodAccess().getAlternatives(), "rule__Colprod__Alternatives");
			...
			builder.put(grammarAccess.getInsertColAccess().getGroup_4(), "rule__InsertCol__Group_4__0");
			builder.put(grammarAccess.getRemoveColAccess().getGroup_0(), "rule__RemoveCol__Group_0__0");
			builder.put(grammarAccess.getRemoveColAccess().getGroup_1(), "rule__RemoveCol__Group_1__0");
			builder.put(grammarAccess.getInsertLineAccess().getGroup(), "rule__InsertLine__Group__0");
			builder.put(grammarAccess.getInsertLineAccess().getGroup_2(), "rule__InsertLine__Group_2__0");
			...
			builder.put(grammarAccess.getColsumAccess().getGroup_0(), "rule__Colsum__Group_0__0");
			builder.put(grammarAccess.getColsumAccess().getGroup_1(), "rule__Colsum__Group_1__0");
			builder.put(grammarAccess.getLineprodAccess().getGroup(), "rule__Lineprod__Group__0");
			builder.put(grammarAccess.getColprodAccess().getGroup_0(), "rule__Colprod__Group_0__0");
			builder.put(grammarAccess.getColprodAccess().getGroup_1(), "rule__Colprod__Group_1__0");
			...
			builder.put(grammarAccess.getInsertColAccess().getExpAssignment_4_1(), "rule__InsertCol__ExpAssignment_4_1");
			builder.put(grammarAccess.getRemoveColAccess().getColIndexAssignment_0_1(), "rule__RemoveCol__ColIndexAssignment_0_1");
			builder.put(grammarAccess.getRemoveColAccess().getNameAssignment_1_0(), "rule__RemoveCol__NameAssignment_1_0");
			builder.put(grammarAccess.getInsertLineAccess().getLineIndexAssignment_1(), "rule__InsertLine__LineIndexAssignment_1");
			builder.put(grammarAccess.getInsertLineAccess().getExpsAssignment_2_1(), "rule__InsertLine__ExpsAssignment_2_1");
			...
			builder.put(grammarAccess.getInsertAccess().getColNameOrIndexAssignment_3(), "rule__Insert__ColNameOrIndexAssignment_3");
			...
			builder.put(grammarAccess.getSelectcellAccess().getCellXAssignment_1(), "rule__Selectcell__CellXAssignment_1");
			builder.put(grammarAccess.getSelectcellAccess().getCellYAssignment_3(), "rule__Selectcell__CellYAssignment_3");
			builder.put(grammarAccess.getLinesumAccess().getLineIndexAssignment_1(), "rule__Linesum__LineIndexAssignment_1");
			builder.put(grammarAccess.getColsumAccess().getColIndexAssignment_0_1(), "rule__Colsum__ColIndexAssignment_0_1");
			builder.put(grammarAccess.getColsumAccess().getNameAssignment_1_0(), "rule__Colsum__NameAssignment_1_0");
			builder.put(grammarAccess.getLineprodAccess().getLineIndexAssignment_1(), "rule__Lineprod__LineIndexAssignment_1");
			builder.put(grammarAccess.getColprodAccess().getColIndexAssignment_0_1(), "rule__Colprod__ColIndexAssignment_0_1");
			builder.put(grammarAccess.getColprodAccess().getNameAssignment_1_0(), "rule__Colprod__NameAssignment_1_0");
			builder.put(grammarAccess.getBinexprAccess().getLeftAssignment_1(), "rule__Binexpr__LeftAssignment_1");
			builder.put(grammarAccess.getBinexprAccess().getOpAssignment_2(), "rule__Binexpr__OpAssignment_2");
			builder.put(grammarAccess.getBinexprAccess().getRightAssignment_3(), "rule__Binexpr__RightAssignment_3");
