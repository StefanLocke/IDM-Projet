 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.idmdsl.impl.ColprodImpl#getColName <em>Col Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ColprodImpl extends MathPrimaryExpressionImpl implements Colprod
{
  /**
  ...
  public NotificationChain basicSetColName(StringValue newColName, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, IdmdslPackage.COLPROD__COL_NAME, oldColName, newColName);
  ...
  public void setColName(StringValue newColName)
  {
    if (newColName != colName)
    {
      ...
      if (colName != null)
        msgs = ((InternalEObject)colName).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - IdmdslPackage.COLPROD__COL_NAME, null, msgs);
      if (newColName != null)
        msgs = ((InternalEObject)newColName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - IdmdslPackage.COLPROD__COL_NAME, null, msgs);
      msgs = basicSetColName(newColName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, IdmdslPackage.COLPROD__COL_NAME, newColName, newColName));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case IdmdslPackage.COLPROD__COL_NAME:
